            ...
            <div class="col-sm-auto bg-light sticky-top">
                <div class="d-flex flex-sm-column flex-row flex-nowrap bg-light align-items-center sticky-top">
                    ...
                    <ul
                        ...
                        <li>
                            <a href="../pages/login.php" class="nav-link py-3 px-3 logout" title=""
                                data-bs-toggle="tooltip" data-bs-placement="right" data-bs-original-title="Orders">
                ...
                <main class="">
                    ...
                    <section>
                        <div class=" mt-4">
                            ...
                            <div class="card">
                                <h5 class="card-header py-3">Lista de atendimentos</h5>
                                <div class="card-body">
                                    ...
                                    <div id="pdf">
                                        <button onclick="exportarPDF()" class="btn btn-danger">
                                            <i class="bi bi-file-earmark-spreadsheet"></i> PDF
                                        </button>
                                    </div>

                                    <!-- <h2 class="mb-3"></h2> -->

                                    <table id="table" data-toggle="table" data-pagination="true" data-page-size="10" data-mobile-responsive="true"
                                        ...
                                        <thead>
                                            <tr>
                                                <th data-field="atendente" data-sortable="true">Atendente</th>
                                                <th data-field="atendido" data-sortable="true">Atendido</th>
