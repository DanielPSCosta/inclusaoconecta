...
<head>
    ...
    <meta name="description"
        content="Inclusão conecta: inclusão digital, suporte tecnológico e aulas simples para idosos e pessoas que precisam de ajuda com tecnologia.">
    <meta name="google-site-verification" content="oRx3_iJyLkLJ7OpLR4Y9wIK5Wi-7w339mnP58vgu1V0" />
...
<body>
    ...
    <main class="main-content">
            ...
            <div class="container">
                <div class="row align-items-center g-4 g-lg-5">
                    <div class="col-lg-6 text-center text-lg-start">
                        <span class="eyebrow">Tecnologia sem complicação</span>
                        <h1 class="hero-title">Facilidade digital para <span>meia idade e idosos</span>.</h1>
                        <p class="hero-subtitle">
                            A Inclusão conecta ajuda pessoas a usarem celular, computador, aplicativos e serviços
                            digitais com
                            paciência, linguagem simples e acompanhamento humano.
                        </p>
        ...
        <section class="section-padding" id="servicos">
            <div class="container">
                ...
                <p class="section-subtitle">
                    A ideia é simples, coisa rara nesse planeta: pegar tecnologia confusa e transformar em algo usável
                    para quem precisa viver melhor no digital.
                </p>

                <div class="row g-4">
                    <div class="col-md-6 col-lg-3">
                        <article class="service-card card v-card h-100 border-0 p-4">
                            <span class="icon-box">📱</span>
                            <h3>Celular e aplicativos</h3>
                            <p>Ajuda para usar WhatsApp, chamadas de vídeo, fotos, mapas, redes sociais e configurações
                                básicas.</p>
                        </article>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-3">
                        <article class="service-card card v-card h-100 border-0 p-4">
                            <span class="icon-box">💻</span>
                            <h3>Computador e notebook</h3>
                            <p>Organização de arquivos, e-mail, internet, impressora, antivírus e resolução de problemas
                                comuns.</p>
                        </article>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-3">
                        <article class="service-card card v-card h-100 border-0 p-4">
                            ...
                            <p>Ajuste de letras maiores, contraste, leitura de tela, comandos por voz e recursos de
                                autonomia digital.</p>
                        </article>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-3">
                        <article class="service-card card v-card h-100 border-0 p-4">
                            ...
                            <p>Orientação contra golpes, links suspeitos, senhas fracas e armadilhas digitais que
                                ninguém merece.</p>
                        </article>
                    </div>
                </div>
        ...
        <section class="section-padding">
            <div class="container">
                <h2 class="section-title">Por que escolher a Inclusão conecta?</h2>
                <p class="section-subtitle">
                    Porque ninguém deveria depender de sorte, neto disponível ou tutorial duvidoso no YouTube para
                    resolver algo básico no celular.
                </p>

                <div class="row g-4">
                    <div class="col-md-4">
                        <div class="beneficio-card card v-card h-100 border-0 p-4 text-center">
                            <span class="icon-box mx-auto">💚</span>
                            <h4>Atendimento humanizado</h4>
                            <p>Suporte paciente, respeitoso e adaptado ao ritmo de cada pessoa.</p>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="beneficio-card card v-card h-100 border-0 p-4 text-center">
                            <span class="icon-box mx-auto">🏠</span>
                            <h4>Remoto ou presencial</h4>
                            <p>Ajuda online para agilidade e visitas presenciais quando necessário.</p>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="beneficio-card card v-card h-100 border-0 p-4 text-center">
                            <span class="icon-box mx-auto">🔎</span>
                            <h4>Explicação prática</h4>
                            <p>Sem enrolação técnica. A pessoa aprende fazendo.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <script>
            // Botões de leitura lateral 
            // API que já vem embutida nos navegadores
            function lerTexto() {
        ...
        <!-- <div class="toast-container position-fixed top-0 start-50 translate-middle-x p-1" style="z-index: 9999;">
            <div id="installToast" class="toast" role="alert">
                <div class="toast-body d-flex align-items-center justify-content-between">
                    <span>📱 Instale o aplicativo</span>

                    <div class="ms-3">
                        <button id="btnInstalar" class="btn btn-primary btn-sm">
                            Instalar
                        </button>

                        <button type="button" class="btn-close ms-2" id="btnFecharToast">
                        </button>
                    </div>
                </div>
            </div>
            ...
            <div id="installToast" class="toast" role="alert">
                <div class="toast-body">
                    ...
                    <div id="androidInstall" style="display: none;">
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <div>
                                ...
                                <button type="button" class="btn-close ms-2" id="btnFecharToast"></button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="iosInstall" style="display: none;">
                        <div class="d-flex align-items-center justify-content-between">
                            <small>
                                📱 Toque em Compartilhar ⬆️ e depois em
                                <strong>Adicionar à Tela de Início</strong>
                            </small>

                            <button type="button" class="btn-close ms-2" id="btnFecharToastIOS"></button>
                        </div>
                    </div>
